...
Assert-True ($css -match 'bottom:\s*8px|bottom:\s*env\(') 'mobile info panel must be bottom anchored'
Assert-True ($css -match 'max-height:\s*min\(') 'mobile info panel must be scrollable and bounded'
