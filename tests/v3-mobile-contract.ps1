...
Assert-True ($css -match 'safe-area-inset-top') 'mobile layout must protect the top safe area'
Assert-True ($css -match 'safe-area-inset-left') 'mobile layout must protect the left safe area'
Assert-True ($css -match 'safe-area-inset-right') 'mobile layout must protect the right safe area'
Assert-True ($css -match 'safe-area-inset-bottom') 'mobile layout must protect the bottom safe area'
